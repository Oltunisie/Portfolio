    ...
    <section id="contact" className="py-32 px-6 bg-white">
      <div className="max-w-2xl mx-auto text-center" ref={ref}>
        ...
        >
          ...
          <p className="text-slate-400 font-light mb-14 text-lg">
            Whether it&apos;s research, collaboration, or just a conversation about aerospace —
      ...
      <motion.div
        ...
        className="mt-24 text-center text-xs text-slate-300 tracking-widest"
      >
